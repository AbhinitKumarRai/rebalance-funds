...
import fs from "fs";
export const setupCrossChainMessengerFoEth = async (privateKey) => {
...
export const setupCrossChainMessengerForMnt = async (privateKey) => {
    let crossChainMessenger;
    let l1MntContract;
    const L1RpcProvider = new ethers.providers.JsonRpcProvider({
        url: environment.l1Rpc,
    ...
    const L1TestERC20 = JSON.parse(fs.readFileSync("./abis/TestERC20.json", "utf-8"));
    l1MntContract = new ethers.Contract(environment.l1Mnt, L1TestERC20.abi, l1Wallet);
