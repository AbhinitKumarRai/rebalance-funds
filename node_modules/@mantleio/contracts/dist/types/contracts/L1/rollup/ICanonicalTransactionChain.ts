...
export interface ICanonicalTransactionChainInterface extends utils.Interface {
  functions: {
    ...
    "resetIndex(uint256,uint40,uint40,uint40,uint40,uint40,uint40)": FunctionFragment;
  ...
  decodeFunctionResult(functionFragment: "resetIndex", data: BytesLike): Result;
  decodeFunctionResult(
    functionFragment: "setGasParams",
    data: BytesLike
  ): Result;
  ...
  events: {
    "CTCBatchReset(uint256,uint40,uint40,uint40,uint40,uint40,uint40)": EventFragment;
  ...
  getEvent(nameOrSignatureOrTopic: "CTCBatchReset"): EventFragment;
...
export interface CTCBatchResetEventObject {
  _batchIndex: BigNumber;
  _nextqIndex: number;
  _totalElement: number;
  _batchSize: number;
  _numQueuedTransactions: number;
  _timestamp: number;
  _blockNumber: number;
}
export type CTCBatchResetEvent = TypedEvent<
  [BigNumber, number, number, number, number, number, number],
  CTCBatchResetEventObject
>;

export type CTCBatchResetEventFilter = TypedEventFilter<CTCBatchResetEvent>;
...
export interface ICanonicalTransactionChain extends BaseContract {
  ...
  functions: {
    ...
    resetIndex(
      ...
      _totalElement: PromiseOrValue<BigNumberish>,
      _batchSize: PromiseOrValue<BigNumberish>,
      _nextqIndex: PromiseOrValue<BigNumberish>,
      _numQueuedTransactions: PromiseOrValue<BigNumberish>,
  ...
  filters: {
    "CTCBatchReset(uint256,uint40,uint40,uint40,uint40,uint40,uint40)"(
      _batchIndex?: PromiseOrValue<BigNumberish> | null,
      _nextqIndex?: null,
      _totalElement?: null,
      _batchSize?: null,
      _numQueuedTransactions?: null,
      _timestamp?: null,
      _blockNumber?: null
    ): CTCBatchResetEventFilter;
    CTCBatchReset(
      _batchIndex?: PromiseOrValue<BigNumberish> | null,
      _nextqIndex?: null,
      _totalElement?: null,
