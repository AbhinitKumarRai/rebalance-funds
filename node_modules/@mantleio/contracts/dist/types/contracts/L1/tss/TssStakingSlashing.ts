...
export interface TssStakingSlashingInterface extends utils.Interface {
  functions: {
    ...
    "setTssManager(address)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "setTssManager",
    values: [PromiseOrValue<string>]
  ): string;
  encodeFunctionData(
  ...
  decodeFunctionResult(functionFragment: "tssManager", data: BytesLike): Result;
...
export interface TssStakingSlashing extends BaseContract {
  ...
  functions: {
    ...
    initialize(
      ...
      _tssManager: PromiseOrValue<string>,
      overrides?: Overrides & { from?: PromiseOrValue<string> }
    ): Promise<ContractTransaction>;
    ...
    tssManager(overrides?: CallOverrides): Promise<[string]>;
  ...
  estimateGas: {
    ...
    tssManager(overrides?: CallOverrides): Promise<BigNumber>;
  ...
  populateTransaction: {
    ...
    tssManager(overrides?: CallOverrides): Promise<PopulatedTransaction>;
