...
import type {
  StackOpVerifier,
  StackOpVerifierInterface,
} from "../../../../../../contracts/L1/fraud-proof/verifier/subverifiers/StackOpVerifier";
...
type StackOpVerifierConstructorParams =
  | [signer?: Signer]
  | ConstructorParameters<typeof ContractFactory>;

const isSuperArgs = (
  xs: StackOpVerifierConstructorParams
): xs is ConstructorParameters<typeof ContractFactory> => xs.length > 1;

export class StackOpVerifier__factory extends ContractFactory {
  constructor(...args: StackOpVerifierConstructorParams) {
    if (isSuperArgs(args)) {
      super(...args);
    } else {
  ...
  ): Promise<StackOpVerifier> {
    return super.deploy(overrides || {}) as Promise<StackOpVerifier>;
  }
  ...
  override attach(address: string): StackOpVerifier {
    return super.attach(address) as StackOpVerifier;
  }
  override connect(signer: Signer): StackOpVerifier__factory {
    return super.connect(signer) as StackOpVerifier__factory;
  }

  static readonly bytecode = _bytecode;
  static readonly abi = _abi;
  static createInterface(): StackOpVerifierInterface {
    return new utils.Interface(_abi) as StackOpVerifierInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): StackOpVerifier {
    return new Contract(address, _abi, signerOrProvider) as StackOpVerifier;
  }
}
