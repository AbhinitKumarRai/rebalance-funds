...
import type {
  IQuorumRegistry,
  IQuorumRegistryInterface,
} from "../../../../../contracts/libraries/eigenda/interfaces/IQuorumRegistry";
...
export class IQuorumRegistry__factory {
  static readonly abi = _abi;
  static createInterface(): IQuorumRegistryInterface {
    return new utils.Interface(_abi) as IQuorumRegistryInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): IQuorumRegistry {
    return new Contract(address, _abi, signerOrProvider) as IQuorumRegistry;
  }
}
