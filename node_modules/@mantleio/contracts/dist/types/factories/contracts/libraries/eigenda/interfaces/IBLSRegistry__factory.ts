...
import type {
  IBLSRegistry,
  IBLSRegistryInterface,
} from "../../../../../contracts/libraries/eigenda/interfaces/IBLSRegistry";
...
export class IBLSRegistry__factory {
  static readonly abi = _abi;
  static createInterface(): IBLSRegistryInterface {
    return new utils.Interface(_abi) as IBLSRegistryInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): IBLSRegistry {
    return new Contract(address, _abi, signerOrProvider) as IBLSRegistry;
  }
}
