...
const hashCrossDomainMessage = (nonce, sender, target, mntValue, ethValue, gasLimit, data) => {
    ...
    if (version.eq(0)) {
        ...
        return (0, exports.hashCrossDomainMessagev1)(nonce, sender, target, mntValue, ethValue, gasLimit, data);
    }
...
const hashCrossDomainMessagev1 = (nonce, sender, target, mntValue, ethValue, gasLimit, data) => {
    return (0, keccak256_1.keccak256)((0, encoding_1.encodeCrossDomainMessageV1)(nonce, sender, target, mntValue, ethValue, gasLimit, data));
};
exports.hashCrossDomainMessagev1 = hashCrossDomainMessagev1;
const hashWithdrawal = (nonce, sender, target, mntValue, ethValue, gasLimit, data) => {
    const types = [
        'uint256',
        'address',
        'address',
