...
const encodeCrossDomainMessageV1 = (nonce, sender, target, mntValue, ethValue, gasLimit, data) => {
    return iface.encodeFunctionData('relayMessage(uint256,address,address,uint256,uint256,uint256,bytes)', [nonce, sender, target, mntValue, ethValue, gasLimit, data]);
};
exports.encodeCrossDomainMessageV1 = encodeCrossDomainMessageV1;
const encodeCrossDomainMessage = (nonce, sender, target, mntValue, ethValue, gasLimit, data) => {
    ...
    if (version.eq(0)) {
        ...
        return (0, exports.encodeCrossDomainMessageV1)(nonce, sender, target, mntValue, ethValue, gasLimit, data);
    }
