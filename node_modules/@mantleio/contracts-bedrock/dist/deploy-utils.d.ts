...
export declare const deploySleepTime: number;
...
export declare const isStartOfPhase: (dictator: ethers.Contract, phase: number) => Promise<boolean>;
...
export declare const doPhase: (opts: {
    isLiveDeployer?: boolean;
    SystemDictator: ethers.Contract;
    phase: number;
    message: string;
