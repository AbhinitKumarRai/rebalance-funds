...
let BVM_ETH;
try {
    BVM_ETH = require('../artifacts/contracts/L2/BVM_ETH.sol/BVM_ETH.json');
}
catch (_3) { }
...
let LegacyERC20MNT;
try {
    LegacyERC20MNT = require('../artifacts/contracts/legacy/LegacyERC20MNT.sol/LegacyERC20MNT.json');
}
catch (_17) { }
...
let L1TestToken;
try {
    L1TestToken = require('../artifacts/contracts/local/L1TestToken.sol/L1TestToken.json');
}
catch (_38) { }
let L2TestToken;
try {
    L2TestToken = require('../artifacts/contracts/local/L2TestToken.sol/L2TestToken.json');
}
catch (_39) { }
let LocalConstants;
try {
    LocalConstants = require('../artifacts/contracts/local/LocalConstants.sol/LocalConstants.json');
}
catch (_40) { }
let L1MantleToken;
try {
    L1MantleToken = require('../artifacts/contracts/local/TestMantleToken.sol/L1MantleToken.json');
}
catch (_41) { }
let TransferOnion;
try {
