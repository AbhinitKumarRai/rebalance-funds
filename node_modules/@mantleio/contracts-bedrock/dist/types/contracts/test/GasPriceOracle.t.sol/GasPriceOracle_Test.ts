...
export interface GasPriceOracle_TestInterface extends utils.Interface {
  functions: {
    ...
    "test_getL1Fee_succeeds()": FunctionFragment;
    "test_getL1GasUsed_succeeds()": FunctionFragment;
  ...
  getFunction(
    nameOrSignatureOrTopic:
      ...
      | "test_getL1Fee_succeeds"
      | "test_getL1GasUsed_succeeds"
  ...
  encodeFunctionData(
    functionFragment: "test_getL1Fee_succeeds",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "test_getL1GasUsed_succeeds",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export interface GasPriceOracle_Test extends BaseContract {
  ...
  callStatic: {
    ...
    test_getL1Fee_succeeds(overrides?: CallOverrides): Promise<void>;

    test_getL1GasUsed_succeeds(overrides?: CallOverrides): Promise<void>;
