...
export interface L1StandardBridge_BridgeMNT_TestInterface
  ...
  functions: {
    ...
    "test_bridgeMNT_succeeds()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "test_bridgeMNT_succeeds",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export interface L1StandardBridge_BridgeMNT_Test extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: L1StandardBridge_BridgeMNT_TestInterface;
  ...
  callStatic: {
    ...
    test_bridgeMNT_succeeds(overrides?: CallOverrides): Promise<void>;
