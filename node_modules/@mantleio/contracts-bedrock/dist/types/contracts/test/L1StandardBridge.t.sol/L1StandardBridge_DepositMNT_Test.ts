...
export interface L1StandardBridge_DepositMNT_TestInterface
  ...
  functions: {
    ...
    "test_depositMNT_succeeds()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "test_depositMNT_succeeds",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export interface L1StandardBridge_DepositMNT_Test extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: L1StandardBridge_DepositMNT_TestInterface;
  ...
  callStatic: {
    ...
    test_depositMNT_succeeds(overrides?: CallOverrides): Promise<void>;
