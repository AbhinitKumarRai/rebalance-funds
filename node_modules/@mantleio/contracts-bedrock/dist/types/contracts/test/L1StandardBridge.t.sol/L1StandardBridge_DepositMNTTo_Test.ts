...
export interface L1StandardBridge_DepositMNTTo_TestInterface
  ...
  functions: {
    ...
    "test_depositMNTTo_succeeds()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "test_depositMNTTo_succeeds",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export interface L1StandardBridge_DepositMNTTo_Test extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: L1StandardBridge_DepositMNTTo_TestInterface;
  ...
  callStatic: {
    ...
    test_depositMNTTo_succeeds(overrides?: CallOverrides): Promise<void>;
