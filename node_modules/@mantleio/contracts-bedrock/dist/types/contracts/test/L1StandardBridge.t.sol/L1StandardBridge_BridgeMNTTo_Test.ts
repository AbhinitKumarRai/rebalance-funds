...
export interface L1StandardBridge_BridgeMNTTo_TestInterface
  ...
  functions: {
    ...
    "test_bridgeMNTTo_succeeds()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "test_bridgeMNTTo_succeeds",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export interface L1StandardBridge_BridgeMNTTo_Test extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: L1StandardBridge_BridgeMNTTo_TestInterface;
  ...
  callStatic: {
    ...
    test_bridgeMNTTo_succeeds(overrides?: CallOverrides): Promise<void>;
