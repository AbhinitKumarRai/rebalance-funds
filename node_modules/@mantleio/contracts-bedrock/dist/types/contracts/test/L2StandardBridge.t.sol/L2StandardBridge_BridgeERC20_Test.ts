...
export interface L2StandardBridge_BridgeERC20_TestInterface
  ...
  functions: {
    ...
    "test_burnLegacyERC20_succeeds()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "test_burnLegacyERC20_succeeds",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export interface L2StandardBridge_BridgeERC20_Test extends BaseContract {
  ...
  callStatic: {
    ...
    test_burnLegacyERC20_succeeds(overrides?: CallOverrides): Promise<void>;
