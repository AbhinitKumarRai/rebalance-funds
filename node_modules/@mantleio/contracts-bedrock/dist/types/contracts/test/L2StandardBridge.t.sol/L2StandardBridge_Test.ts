...
export interface L2StandardBridge_TestInterface extends utils.Interface {
  functions: {
    ...
    "test_withdraw_mnt_succeeds()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "test_withdraw_mnt_succeeds",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export interface L2StandardBridge_Test extends BaseContract {
  ...
  callStatic: {
    ...
    test_withdraw_mnt_succeeds(overrides?: CallOverrides): Promise<void>;
