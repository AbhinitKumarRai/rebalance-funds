...
export interface BVM_ETH_TestInterface extends utils.Interface {
  functions: {
    ...
    "test_mint_reverts()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "test_mint_reverts",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export interface BVM_ETH_Test extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: BVM_ETH_TestInterface;
  ...
  callStatic: {
    ...
    test_mint_reverts(overrides?: CallOverrides): Promise<void>;
