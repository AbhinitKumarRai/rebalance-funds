...
export interface OptimismPortal_Invariant_Harness_MNTInterface
...
export interface OptimismPortal_Invariant_Harness_MNT extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: OptimismPortal_Invariant_Harness_MNTInterface;
