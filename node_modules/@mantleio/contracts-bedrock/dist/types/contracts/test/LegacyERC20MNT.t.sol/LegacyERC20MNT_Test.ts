...
export interface LegacyERC20MNT_TestInterface extends utils.Interface {
  functions: {
...
export interface LegacyERC20MNT_Test extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: LegacyERC20MNT_TestInterface;
