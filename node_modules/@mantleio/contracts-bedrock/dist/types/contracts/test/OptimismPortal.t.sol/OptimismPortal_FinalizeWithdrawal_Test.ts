...
export interface OptimismPortal_FinalizeWithdrawal_TestInterface
  ...
  functions: {
    ...
    "testDiff_finalizeWithdrawalTransaction_succeeds(address,address,uint256,uint256,bytes)": FunctionFragment;
    ...
    "test_finalizeWithdrawalTransaction_onReentrancy_reverts()": FunctionFragment;
    ...
    "test_finalizeWithdrawalTransaction_provenWithdrawalHash_succeeds()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "testDiff_finalizeWithdrawalTransaction_succeeds",
    values: [
  ...
  encodeFunctionData(
    functionFragment: "test_finalizeWithdrawalTransaction_onReentrancy_reverts",
    values?: undefined
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "test_finalizeWithdrawalTransaction_provenWithdrawalHash_succeeds",
    values?: undefined
  ): string;
  encodeFunctionData(
