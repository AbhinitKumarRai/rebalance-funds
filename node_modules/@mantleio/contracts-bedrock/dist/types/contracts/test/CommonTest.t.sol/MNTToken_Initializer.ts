...
export interface MNTToken_InitializerInterface extends utils.Interface {
  functions: {
...
export interface MNTToken_Initializer extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: MNTToken_InitializerInterface;
