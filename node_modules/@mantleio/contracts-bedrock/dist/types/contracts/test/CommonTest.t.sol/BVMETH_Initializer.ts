...
export interface BVMETH_InitializerInterface extends utils.Interface {
  functions: {
...
export interface BVMETH_Initializer extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: BVMETH_InitializerInterface;
