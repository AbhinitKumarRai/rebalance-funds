...
export interface Encoding_TestInterface extends utils.Interface {
  functions: {
    ...
    "testDiff_encodeCrossDomainMessage_succeeds(uint240,uint8,address,address,uint256,uint256,uint256,bytes)": FunctionFragment;
    "testDiff_encodeDepositTransaction_succeeds(address,address,uint256,uint256,uint256,uint64,bool,bytes,uint64)": FunctionFragment;
