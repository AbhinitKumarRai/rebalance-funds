...
export interface L1StandardBridgeInterface extends utils.Interface {
  functions: {
    "L1_MNT_ADDRESS()": FunctionFragment;
    ...
    "bridgeMNT(uint256,uint32,bytes)": FunctionFragment;
    "bridgeMNTTo(address,uint256,uint32,bytes)": FunctionFragment;
    ...
    "depositMNT(uint256,uint32,bytes)": FunctionFragment;
    "depositMNTTo(address,uint256,uint32,bytes)": FunctionFragment;
    ...
    "finalizeBridgeMNT(address,address,uint256,bytes)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "L1_MNT_ADDRESS",
    values?: undefined
  ): string;
  ...
  encodeFunctionData(
    functionFragment: "finalizeBridgeMNT",
    values: [
      PromiseOrValue<string>,
      PromiseOrValue<string>,
      PromiseOrValue<BigNumberish>,
  ...
  decodeFunctionResult(functionFragment: "bridgeMNT", data: BytesLike): Result;
  decodeFunctionResult(
    functionFragment: "bridgeMNTTo",
    data: BytesLike
  ): Result;
  ...
  decodeFunctionResult(functionFragment: "depositMNT", data: BytesLike): Result;
  decodeFunctionResult(
    functionFragment: "depositMNTTo",
    data: BytesLike
  ): Result;
...
export interface L1StandardBridge extends BaseContract {
  ...
  functions: {
    L1_MNT_ADDRESS(overrides?: CallOverrides): Promise<[string]>;
  ...
  estimateGas: {
    L1_MNT_ADDRESS(overrides?: CallOverrides): Promise<BigNumber>;
  ...
  populateTransaction: {
    L1_MNT_ADDRESS(overrides?: CallOverrides): Promise<PopulatedTransaction>;
