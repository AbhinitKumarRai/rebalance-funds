...
export interface L1CrossDomainMessengerInterface extends utils.Interface {
  functions: {
    ...
    "relayMessage(uint256,address,address,uint256,uint256,uint256,bytes)": FunctionFragment;
    "sendMessage(uint256,address,bytes,uint32)": FunctionFragment;
...
export interface L1CrossDomainMessenger extends BaseContract {
  ...
  functions: {
    ...
    sendMessage(
      _mntAmount: PromiseOrValue<BigNumberish>,
      _target: PromiseOrValue<string>,
      _message: PromiseOrValue<BytesLike>,
      _minGasLimit: PromiseOrValue<BigNumberish>,
      overrides?: PayableOverrides & { from?: PromiseOrValue<string> }
