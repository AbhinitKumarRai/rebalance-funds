...
export declare namespace Types {
  export type WithdrawalTransactionStruct = {
    ...
    mntValue: PromiseOrValue<BigNumberish>;
...
export interface OptimismPortalInterface extends utils.Interface {
  functions: {
    ...
    "depositTransaction(uint256,address,uint256,uint64,bool,bytes)": FunctionFragment;
    "donateETH()": FunctionFragment;
    "finalizeWithdrawalTransaction((uint256,address,address,uint256,uint256,uint256,bytes))": FunctionFragment;
    ...
    "proveWithdrawalTransaction((uint256,address,address,uint256,uint256,uint256,bytes),uint256,(bytes32,bytes32,bytes32,bytes32),bytes[])": FunctionFragment;
...
export interface OptimismPortal extends BaseContract {
  ...
  functions: {
    ...
    depositTransaction(
      _mntValue: PromiseOrValue<BigNumberish>,
      _to: PromiseOrValue<string>,
      _mntTxValue: PromiseOrValue<BigNumberish>,
