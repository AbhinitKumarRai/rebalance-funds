...
export interface EchidnaFuzzHashingInterface extends utils.Interface {
  functions: {
    ...
    "testHashCrossDomainMessageHighVersion(uint16,uint240,address,address,uint256,uint256,uint256,bytes)": FunctionFragment;
    "testHashCrossDomainMessageV0(uint240,address,address,uint256,uint256,uint256,bytes)": FunctionFragment;
    "testHashCrossDomainMessageV1(uint240,address,address,uint256,uint256,uint256,bytes)": FunctionFragment;
  };
