...
import type {
  BondManager_Test,
  BondManager_TestInterface,
} from "../../../../contracts/test/BondManager.t.sol/BondManager_Test";
...
type BondManager_TestConstructorParams =
  | [signer?: Signer]
  | ConstructorParameters<typeof ContractFactory>;

const isSuperArgs = (
  xs: BondManager_TestConstructorParams
): xs is ConstructorParameters<typeof ContractFactory> => xs.length > 1;

export class BondManager_Test__factory extends ContractFactory {
  constructor(...args: BondManager_TestConstructorParams) {
    if (isSuperArgs(args)) {
      super(...args);
    } else {
  ...
  ): Promise<BondManager_Test> {
    return super.deploy(overrides || {}) as Promise<BondManager_Test>;
  }
  ...
  override attach(address: string): BondManager_Test {
    return super.attach(address) as BondManager_Test;
  }
  override connect(signer: Signer): BondManager_Test__factory {
    return super.connect(signer) as BondManager_Test__factory;
  }

  static readonly bytecode = _bytecode;
  static readonly abi = _abi;
  static createInterface(): BondManager_TestInterface {
    return new utils.Interface(_abi) as BondManager_TestInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): BondManager_Test {
    return new Contract(address, _abi, signerOrProvider) as BondManager_Test;
  }
}
