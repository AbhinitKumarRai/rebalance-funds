...
import type {
  EchidnaFuzzHashing,
  EchidnaFuzzHashingInterface,
} from "../../../../contracts/echidna/FuzzHashing.sol/EchidnaFuzzHashing";
...
type EchidnaFuzzHashingConstructorParams =
  | [signer?: Signer]
  | ConstructorParameters<typeof ContractFactory>;

const isSuperArgs = (
  xs: EchidnaFuzzHashingConstructorParams
): xs is ConstructorParameters<typeof ContractFactory> => xs.length > 1;

export class EchidnaFuzzHashing__factory extends ContractFactory {
  constructor(...args: EchidnaFuzzHashingConstructorParams) {
    if (isSuperArgs(args)) {
      super(...args);
    } else {
  ...
  ): Promise<EchidnaFuzzHashing> {
    return super.deploy(overrides || {}) as Promise<EchidnaFuzzHashing>;
  }
  ...
  override attach(address: string): EchidnaFuzzHashing {
    return super.attach(address) as EchidnaFuzzHashing;
  }
  override connect(signer: Signer): EchidnaFuzzHashing__factory {
    return super.connect(signer) as EchidnaFuzzHashing__factory;
  }

  static readonly bytecode = _bytecode;
  static readonly abi = _abi;
  static createInterface(): EchidnaFuzzHashingInterface {
    return new utils.Interface(_abi) as EchidnaFuzzHashingInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): EchidnaFuzzHashing {
    return new Contract(address, _abi, signerOrProvider) as EchidnaFuzzHashing;
  }
}
